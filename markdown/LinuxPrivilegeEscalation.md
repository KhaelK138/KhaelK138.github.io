...
- Find writable directories with `find / -writable -type d -not -path "/proc/*" -not -path "/sys/*" 2>/dev/null`
- Find writable files with `find / -writable -type f -not -path "/proc/*" -not -path "/sys/*" 2>/dev/null`
